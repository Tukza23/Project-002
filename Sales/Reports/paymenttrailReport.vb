...
Public Class paymenttrailReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "RUSI_Sales_Management_System.paymenttrailReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedpaymenttrailReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As paymenttrailReport = New paymenttrailReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
